...
<link rel="stylesheet" href="styles/employeeReportHome.css">
<link rel="stylesheet"
...
<body>
			...
			<ul class="navbar-nav mr-auto  ">
				...
				<li class="nav-item"><a href="portfolio.html"
					...
					style="font-family: 'Raleway', sans-serif;"> <i
						class="bi bi-info-circle pr-2"></i><b>About</b>
				</a></li>
				<li class="nav-item"><a href="contact.html"
					class="nav-link h5 mr-2" id="item"
					style="font-family: 'Raleway', sans-serif;"><i
						class="bi bi-person-lines-fill pr-2"></i> <b>Contact</b> </a></li>
			</ul>
		</div>
	...
	<form class="form mx-auto" action="reportMonthlyLeave" method="post" style ="margin-top: 150px;">
		...
		<button style="box-shadow: none; margin-left: 330px; height: 60px; width:300px; border-radius: 10px;" class="btn btn-info" name="report" 
			id="report">Monthly Employee Leaving Report</button>
