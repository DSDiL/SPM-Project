...
<body>
	...
	<center>
		...
		<div class="form mx-auto" style ="margin-top: 80px;">
			<h2 class="text-center text-white">Employee Management</h2>
			<div class="list-group">

				<a href="employeeID.jsp">
					<button type="button" name="em" style="width: 30%; height: 50px; font-size: 18px;"
						class="btn btn-info mt-5 mx-auto">Employee Details</button>
				</a> <a href="employeeSignup.jsp">
					<button type="button" name="sign" style="width: 30%; height: 50px; font-size: 18px;"
						class="btn btn-info mt-5 mx-auto">Create Employee Profile</button>
				</a>



				<form action="leavingDetails" method="post">
					<button type="submit" name="sign" style="width: 30%; height: 50px; font-size: 18px;"
						class="btn btn-info mt-5 mx-auto">Leaving Approvals</button>
				</form>

				<a href="empReportHome.jsp">
					<button type="button" name="sign" style="width: 30%; height: 50px; font-size: 18px;"
						class="btn btn-info mt-5 mx-auto">Reports</button>
				</a>
