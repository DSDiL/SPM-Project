		...
		<c:if test="${type=='Air Conditions'}">
			<form action="onGoingDelete" method="post">
				<label>Do you want to delete Customer No.<input
					style="background-color: transparent; outline: none; border: none; text-align: center; width: 2%"
					type="text" name="cID" value="<%=cID%>" readonly>'s <input
					style="background-color: transparent; outline: none; border: none; text-align: center; width: 12%"
					type="text" name="type" value="<%=type%>" readonly> Repair
					No.<input
					style="background-color: transparent; outline: none; border: none; text-align: center; width: 2%"
					type="text" name="raID" value="<%=raID%>" readonly> :
				</label><br> <br>
		...
		<c:if test="${type=='Computers'}">
			<form action="onGoingDelete" method="post">
				<label>Do you want to delete Customer No.<input
					style="background-color: transparent; outline: none; border: none; text-align: center; width: 2%"
					type="text" name="cID" value="<%=cID%>" readonly>'s <input
					style="background-color: transparent; outline: none; border: none; text-align: center; width: 9%"
					type="text" name="type" value="<%=type%>" readonly> Repair
					No.<input
					style="background-color: transparent; outline: none; border: none; text-align: center; width: 2%"
					type="text" name="rcID" value="<%=rcID%>" readonly> :
				</label><br> <br>
				<button type="submit" class="btn btn-danger">Delete</button>
			</form>
		</c:if>
		<c:if test="${type=='Other Electronics'}">
			<form action="onGoingDelete" method="post">
				<label>Do you want to delete Customer No.<input
					style="background-color: transparent; outline: none; border: none; text-align: center; width: 2%"
					type="text" name="cID" value="<%=cID%>" readonly>'s <input
					style="background-color: transparent; outline: none; border: none; text-align: center; width: 16%"
					type="text" name="type" value="<%=type%>" readonly> Repair
					No.<input
					style="background-color: transparent; outline: none; border: none; text-align: center; width: 2%"
					type="text" name="roID" value="<%=roID%>" readonly> :
				</label><br> <br>
				<button type="submit" class="btn btn-danger">Delete</button>
			</form>
		</c:if>
