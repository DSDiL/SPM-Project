...
<body>
	...
	<div class="form mx-auto">
		...
		<div class="container" >
			<form action="CustomerRegisterServlet" method="post" name="myform">
<div style="padding-left: 10%;">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="text" name="phone" class="form-control"
							style="width: 70%;" pattern="07[1,2,5,6,7,8][0-9]+"
				...
				<div class="text-center">
					<button type="submit" onclick="return validateForm()" value="Register"
