...
<body>
	...
	<div class="form mx-auto">
		...
		<h2 class="text-center">Hardware Repair</h2>

		<div class="container p-3">
			<form class="text-center" action="repairHardware" method="post">

				<div class="form-group row">
					<label for="" class="col-sm-2 col-form-label">Appointment ID</label>
					<div class="col-sm-10">
						<input type="number" name="appID" class="form-control"
							style="width: 57%;" value="<%=appID%>" readonly />
					</div>
				</div>
				<div class="form-group row">
					<label for="" class="col-sm-2 col-form-label">Customer ID</label>
					<div class="col-sm-10">
						<input type="number" name="cID" style="width: 57%;"
							class="form-control" value="<%=cid%>" readonly />
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="text" name="com" style="width: 57%;"
							class="form-control" required />
					</div>
				</div>

				<div class="form-group row">
					<label for="" class="col-sm-2 col-form-label">Date of
						Acceptance</label>
					<div class="col-sm-10">
						<input type="date" name="date" style="width: 57%;"
							class="form-control" required />
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<textarea name="des" rows="8" style="width: 57%;"
							class="form-control" cols="80"></textarea>
					</div>
				</div>
				...
				<!-- <div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="text" name="spare" style="width: 57%;"
							class="form-control" />
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="number" name="qty" style="width: 57%;"
							class="form-control" />
					</div>
				</div> -->

				<div class="form-group row">
					<label for="" class="col-sm-2 col-form-label">Estimated
						Cost</label>
					<div class="col-sm-10">
						<input type="number" name="cost" style="width: 57%;"
							class="form-control" required />
					</div>
				</div>
