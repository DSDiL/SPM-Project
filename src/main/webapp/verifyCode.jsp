...
<body>
	...
	<div class="form mx-auto"  style="width:70%">

		<h2 class="text-center text-dark">
			<b>E-mail Verification Code</b>
		</h2>
		
		<div class="container">
			<form action="VerifyCodeServlet" method="post" name="myform">
			
			<c:forEach var="verify" items="${verify}">
					<c:set var="email" value="${verify.email}" />			
				
				<div class="form-group row">
					<label class="col-lg-3 col-form-label"><b>Your E-mail</b></label>
					<div class="col-lg-9">
						<input type="text" name="email" class="form-control" value="${verify.email}"
							style="width: 70%;" readonly />
					</div>
				</div>
				<div class="form-group row">
					<label class="col-lg-3 col-form-label"><b>Enter your verification code</b></label>
					<div class="col-lg-9">
