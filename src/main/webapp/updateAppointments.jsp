...
<body>
	...
	<div class="form mx-auto">
		...
		<form action="updateappointments" method="post">


			<div class="form-group row">
				<label for="" class="col-sm-2 col-form-label">Appointment ID</label>
				<div class="col-sm-10">
					<input class="form-control" style="width: 64%;" type="text" id="id"
						name="apoid" value="<%=apoid%> " readonly>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<select id="type" name="type" style="width: 64%;"
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<textarea rows="5" cols="50" name="des" class="form-control"
						style="width: 64%;" required><%=des%></textarea>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<select id="type" name="time" class="form-control"
						style="width: 64%;" required>
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="date" id="date" name="date" class="form-control"
						style="width: 64%;" value="<%=date%>" required>
				</div>
			</div>
