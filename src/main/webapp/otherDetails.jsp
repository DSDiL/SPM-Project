...
<title>Other Electronics Repair Details</title>
...
<body>
	...
	<div class="form mx-auto">
		<h2 class="text-center">
			<b>Other Electronics Repair Details</b>
		</h2>

		<form class="" method="post" action="OtherInsertServlet">

			<table class="table table-striped">
				<c:forEach var="repairOther" items="${repairOther}">


					<c:set var="roID" value="${repairOther.roID}" />
					...
					<c:set var="cost" value="${repairOther.cost}" />
					...
					<tbody>
						<tr>
							...
							<td><input type="text" class="inputt"
								...
								name="roID" value="${repairOther.roID}" readonly></td>
						</tr>
						...
						<tr>
							...
							<td><input type="text" class="inputt"
								style="outline: none; border: none; background-color: transparent"
								name="cID" value="${repairOther.cID}" readonly></td>
						</tr>
						...
						<tr>
							...
							<td><input type="text" class="inputt"
								style="outline: none; border: none; background-color: transparent"
								name="company" value="${repairOther.company}" readonly></td>
						</tr>
						...
						<tr>
							...
							<td><input type="text" class="inputt"
								style="outline: none; border: none; background-color: transparent"
								name="description" value="${repairOther.description}" readonly></td>
						</tr>
						...
						<tr>
							...
							<td><input type="text" class="inputt"
								style="outline: none; border: none; background-color: transparent"
								name="qty" value="${repairOther.qty}" readonly></td>
						</tr>
						...
						<tr>
							...
							<td><input type="text" class="inputt"
								style="outline: none; border: none; background-color: transparent"
								name="cost" value="${repairOther.cost}" readonly></td>
						</tr>
				</c:forEach>
			...
			<div class="text-center">
				<button onclick="insert()" type="submit" id="submit" name="Submit"
