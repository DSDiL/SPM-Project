...
<body>
	...
	<div class="form mx-auto">
		...
		<form action="RepairBillHistoryServlet" method="post">




			<div class="form-group">
				<label class="mt-5" for="cid"><strong>Input The
						Date :</strong></label> <input class="form-control" type="date" id="rid"
					name="date"> <input class="btn btn-success mt-5"
					type="submit" id="submit" value="Bill History">
