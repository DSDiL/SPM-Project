		...
		<div class="container p-3">
			<form class="text-center" action="repairOther" method="post">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="number" class="form-control" style="width: 57%;"
							name="cID" value="<%=cid%>" readonly />
					</div>
				</div>
				...
				<div class="form-group row">
					<label for="" class="col-sm-2 col-form-label">Choose
						Devices</label>
					<div class="col-sm-10">
						<textarea name="dev" rows="8" cols="80" style="width: 57%;"
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<textarea name="des" rows="8" cols="80" class="form-control"
							style="width: 57%;" required></textarea>
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="text" name="spare" class="form-control"
							style="width: 57%;" />
					</div>
				</div>
