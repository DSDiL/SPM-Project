...
<meta charset="UTF-8">
<title>Enter Other Electrics Bill</title>
<meta name="viewport"
...
<body>
	...
	<div class="form mx-auto">
		...
		<form action="OtherBillHistoryServlet" method="post">
			<div class="form-group">
				<label class="mt-5" for="cid"><strong>Enter Other
						Electrics Bill Date :</strong></label> <input class="form-control" type="date"
					id="rid" name="otherdate"> <input
					class="btn btn-success mt-5" type="submit" id="submit"
					value=" Show Bill History">
			</div>
		</form>
