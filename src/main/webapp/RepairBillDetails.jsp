		...
		<form class="" method="post" action="RepairInsert">
			...
			<table class="table table-striped">
				<c:forEach var="repaircomputer" items="${repaircomputer}">
					...
					<c:set var="rcID" value="${repaircomputer.rcID}" />
					<c:set var="company" value="${repaircomputer.company}" />
					<c:set var="date" value="${repaircomputer.date}" />
					<c:set var="deliver" value="${repaircomputer.deliver}" />
					...
					<tbody>
						<tr>
							...
							<td><input type="text" class="inputt"
								...
								name="rcID" value="${repaircomputer.rcID}" readonly></td>
						</tr>
						...
						<tr>
							...
							<td><input type="text" class="inputt"
								style="outline: none; border: none; background-color: transparent"
								name="company" value="${repaircomputer.company}" readonly>
							</td>
						</tr>
						...
						<tr>
							...
							<td><input type="text" class="inputt"
								style="outline: none; border: none; background-color: transparent"
								name="comdate" value="${repaircomputer.date}" readonly></td>
						</tr>
						...
						<tr>
							...
							<td><input type="text" class="inputt"
								style="outline: none; border: none; background-color: transparent"
								name="description" value="${repaircomputer.description}"
								readonly></td>
						</tr>
						...
						<tr>
							...
							<td><input type="text" name="spare"
								style="outline: none; border: none; background-color: transparent"
								class="inputt" value="${repaircomputer.spare}" readonly></td>
						</tr>
				...
				<tr>
					...
					<td><input type="date" name="date" class="form-control w-50"
						pattern="[0-9]+" pattern="[0-9]+" required></td>
				</tr>
			...
			<div class="text-center">
				<button onclick="insert()" type="submit" id="submit" name="Submit"
					...
					class="btn btn-success mt-5 text-center" onclick="insert()">Submit</button>
			</div>
