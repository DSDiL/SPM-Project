	...
	<div class="form mx-auto">
		...
		<div class="list-group text-center">
			<form action="appointmentRetrieve" method="post">
				<button type="submit" style="width: 20%;" class="btn btn-info">Add
					New Repairs</button>
			</form>


			<button type="button" style="width: 20%;"
				onclick="document.location='searchOngoingRepairs.jsp'"
				class="btn btn-info mt-5 mx-auto">Ongoing Repair</button>
			<button type="button" style="width: 20%;"
				onclick="document.location='searchCompletedRepairs.jsp'"
				class="btn btn-info mt-5 mx-auto">Completed Repair</button>
			<button type="button" style="width: 20%;"
				onclick="document.location='repairReportSelect.jsp'"
				class="btn btn-info mt-5 mx-auto">Report</button>
		</div>
	</div>
