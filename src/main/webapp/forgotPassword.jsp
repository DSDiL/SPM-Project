		...
		<div class="container p-3">
			<form name="form" id="form" method="post" action="forgotPassword">
				...
				<div class="form-group row has-success">
					<label>NIC number</label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
					<div class="col-sm-8">
						<input type="text" name="nic" id="nic" pattern="[0-9V]{10}"
				...
				<div class="form-group row has-success">
					<label>Date of birth</label>&nbsp&nbsp&nbsp&nbsp&nbsp
					<div class="col-sm-8">
				...
				<div class="form-group row has-success">
					<label>E-mail address</label>&nbsp
					<div class="col-sm-8">
				...
				<input type="submit" id="submit" style ="width: 150px;"
					class="btn btn-success align-items-center" value="Confirm"><br>
