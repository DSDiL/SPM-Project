...
<meta charset="utf-8">
<title>Other Bill Details Update</title>
<meta name="viewport"
...
<body>
	...
	<div class="form mx-auto w-auto" style="width: 95%;">
		...
		<%
		String billID = request.getParameter("otherbillID");
		String cusID = request.getParameter("otherroID");
		String name = request.getParameter("othername");
		String date = request.getParameter("otherdate");
		String spare = request.getParameter("otherspare");
		String qty = request.getParameter("otherqty");
		String cost = request.getParameter("othercost");
		String spareprice = request.getParameter("otherspareprice");
		String billdate = request.getParameter("otherbilldate");
		String service = request.getParameter("otherservice");
